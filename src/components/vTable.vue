    ...
    methods: {
        ...
        showFilterButton() {
            ...
            storage.getItem('workShopTitle', event => {
                ...
                if (that.name === '胶囊填充室1' || that.name === '胶囊填充室2' || that.name === '胶囊填充室3' || that.name === '压片室1' || that.name === '压片室2') {
                    that.list = that.radio2;
                }
                if (that.name === '制粒室' || that.name === '批混室') {
                    that.list = that.radio3;
                }
                if (that.name === '包衣室') {
                    that.list = that.radio4;
                }
                if (that.name === '瓶包装室' || that.name === '铝塑包装室1' || that.name === '铝塑包装室2' || that.name === '铝塑包装室3') {
