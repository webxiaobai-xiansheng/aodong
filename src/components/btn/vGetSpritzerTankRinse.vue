<template>
    ...
    <div>
        ...
        <div class="btn">
            <wxc-button text="送空料桶清洗" type="blue" :disabled="isDisabled" :btn-style="btnStyle" :text-style="textStyle" @wxcButtonClicked="wxcButtonGetSpritzerHopperRinse"></wxc-button>
        </div>
