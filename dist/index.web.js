...
Component.options.__file = "C:\\Users\\IBM\\Desktop\\awesome-project\\src\\components\\HelloWorld.vue"
...
Component.options.__file = "C:\\Users\\IBM\\Desktop\\awesome-project\\src\\index.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("海涛是我师傅！！！")]), _vm._v(" "), _c('router-view')], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
