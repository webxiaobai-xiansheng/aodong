...
var _vTable = __webpack_require__(7);
...
exports.default = {
  methods: {
    wxcButtonStop: function wxcButtonStop() {
      var _this = this;
      var url = 'http://10.34.10.177:8088/api/agv/stopOrStart/1';
      stream.fetch({
        method: "GET",
        url: url,
        type: 'json'
...
exports.default = {
  methods: {
    wxcButtonStart: function wxcButtonStart() {
      ...
      var url = 'http://10.34.10.177:8088/api/agv/stopOrStart/0';
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["input_item"],
    on: {
      "click": _vm.wxcButtonGetEmptySpritzerTan
    }
  }, [_vm._v(_vm._s(_vm.containerNum))])])]), _c('div', {
    staticClass: ["btns"]
  }, [_c('div', {
    staticClass: ["btn"]
  }, [_c('text', {
